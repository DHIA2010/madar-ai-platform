...
module "vpc" {
  ...
  public_subnets = [
    { cidr = "10.40.1.0/24", az = "${var.aws_region}a" },
    { cidr = "10.40.2.0/24", az = "${var.aws_region}b" }
  ]

  private_subnets = [
    { cidr = "10.40.11.0/24", az = "${var.aws_region}a" },
    { cidr = "10.40.12.0/24", az = "${var.aws_region}b" }
  ]
