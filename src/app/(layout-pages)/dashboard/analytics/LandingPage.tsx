...
import { Check, ShoppingCart, BarChart3, LayoutDashboard, Zap, Code2, Moon } from "lucide-react"
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative py-24 px-6 lg:px-20 text-center bg-gradient-to-b from-background to-muted">
        <Badge className="mb-6 px-4 py-1 text-sm">Built with ShadCN + Tailwind</Badge>
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
          Production-ready React admin dashboard built with ShadCN UI, Tailwind CSS and modern
          architecture. Perfect for SaaS, eCommerce and startup dashboards.
        </p>
      ...
      <section className="py-20 bg-muted px-6 lg:px-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6">Complete eCommerce Module</h2>
          ...
          <div className="bg-background rounded-2xl shadow p-10 text-center">
            ...
            <p className="mt-6 text-muted-foreground">
              Production-ready pages for products, orders, customers and analytics.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted px-6 lg:px-20 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {["React 18+", "ShadCN UI", "Tailwind CSS", "Radix UI", "TypeScript", "Lucide Icons"].map(
            (tech, i) => (
      ...
      <section className="py-24 px-6 lg:px-20 text-center">
        ...
        <h2 className="text-4xl font-bold">Build Your Next SaaS Dashboard 5x Faster</h2>
        <p className="mt-6 text-muted-foreground max-w-2xl mx-auto">
          Stop designing dashboards from scratch. Pulse UI gives you a scalable, modern ShadCN
...
const features = [
  {
    ...
    description: "Clean folder structure, reusable components and scalable React setup.",
  },
  {
    icon: Moon,
    title: "Light & Dark Mode",
    description: "Fully optimized dark mode powered by Tailwind and ShadCN.",
  },
  {
    icon: ShoppingCart,
    title: "eCommerce Ready",
    description: "Complete product, order and customer management system included.",
  },
]
