export const identityOpenApiSpec = {
  openapi: "3.1.0",
  info: {
    title: "MADAR Identity Platform API",
    version: "1.2.0",
    description: "Identity platform REST surface over clean application and domain layers.",
  },
  ...
  paths: {
    ...
    "/v1/auth/register": { post: { summary: "Register user" } },
    "/v1/auth/verify-email": { post: { summary: "Verify email" } },
    "/v1/auth/login": { post: { summary: "Login" } },
    "/v1/auth/refresh": { post: { summary: "Refresh session" } },
    "/v1/auth/logout": { post: { summary: "Logout" } },
    "/v1/auth/sessions/revoke": { post: { summary: "Revoke session" } },
    "/v1/auth/session": { get: { summary: "Get active session" } },
    "/v1/auth/password/forgot": { post: { summary: "Request password reset" } },
    "/v1/auth/password/reset": { post: { summary: "Reset password" } },
    "/v1/identity/profile": {
    ...
    "/v1/organizations/{id}/archive": { post: { summary: "Archive organization" } },
    "/v1/organizations/{id}/restore": { post: { summary: "Restore organization" } },
    "/v1/organizations/{id}/delete": { post: { summary: "Soft delete organization" } },
    "/v1/organizations/{id}/members": { get: { summary: "List organization members" } },
    ...
    "/v1/workspaces/{id}": { patch: { summary: "Update workspace" } },
    "/v1/workspaces/{id}/members": { get: { summary: "List workspace members" } },
    "/v1/workspaces/switch": { post: { summary: "Switch workspace" } },
    "/v1/rbac/permissions": { get: { summary: "Get permission matrix" } },
    "/v1/rbac/me": { get: { summary: "Get resolved permissions" } },
    "/v1/audit/logs": { get: { summary: "List audit logs" } },
    "/v1/integrations/{provider}/sync": {
      post: {
        ...
        responses: {
          ...
          "503": { description: "Transient provider failure." },
        },
      },
    },
    "/v1/integrations/{provider}/records": {
      get: {
        summary: "List normalized provider records",
        description: "Returns provider-independent normalized records persisted by sync runs.",
        responses: {
