...
import type { SallaOAuthStartInput } from "./types"

const CALLBACK_ERROR_REASON_MAP: Record<string, string> = {
  SALLA_OAUTH_STATE_INVALID: "state_invalid",
  SALLA_OAUTH_STATE_EXPIRED: "state_expired",
  SALLA_OAUTH_STATE_ALREADY_CONSUMED: "state_already_consumed",
  SALLA_OAUTH_TOKEN_EXCHANGE_FAILED: "token_exchange_failed",
  SALLA_OAUTH_REFRESH_TOKEN_MISSING: "refresh_token_missing",
  SALLA_OAUTH_ACCOUNT_DISCOVERY_FAILED: "account_discovery_failed",
  SALLA_OAUTH_ACCOUNT_DISCOVERY_EMPTY: "account_discovery_empty",
  SALLA_OAUTH_CONFIGURATION_ERROR: "configuration_error",
}
...
export class SallaOAuthController {
  constructor(private readonly service: SallaOAuthService) {}

  async start(actor: AuthenticatedActor, input: SallaOAuthStartInput) {
