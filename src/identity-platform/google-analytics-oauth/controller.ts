...
import type { GoogleAnalyticsOAuthStartInput } from "./types"

const CALLBACK_ERROR_REASON_MAP: Record<string, string> = {
  GOOGLE_ANALYTICS_OAUTH_STATE_INVALID: "state_invalid",
  GOOGLE_ANALYTICS_OAUTH_STATE_EXPIRED: "state_expired",
  GOOGLE_ANALYTICS_OAUTH_STATE_ALREADY_CONSUMED: "state_already_consumed",
  GOOGLE_ANALYTICS_OAUTH_TOKEN_EXCHANGE_FAILED: "token_exchange_failed",
  GOOGLE_ANALYTICS_OAUTH_REFRESH_TOKEN_MISSING: "refresh_token_missing",
  GOOGLE_ANALYTICS_OAUTH_ACCOUNT_DISCOVERY_FAILED: "account_discovery_failed",
  GOOGLE_ANALYTICS_OAUTH_ACCOUNT_DISCOVERY_EMPTY: "account_discovery_empty",
  GOOGLE_ANALYTICS_OAUTH_CONFIGURATION_ERROR: "configuration_error",
}
...
export class GoogleAnalyticsOAuthController {
  constructor(private readonly service: GoogleAnalyticsOAuthService) {}

  async start(actor: AuthenticatedActor, input: GoogleAnalyticsOAuthStartInput) {
