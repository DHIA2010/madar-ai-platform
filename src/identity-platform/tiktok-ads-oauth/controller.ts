...
import type { TikTokAdsOAuthStartInput } from "./types"

const CALLBACK_ERROR_REASON_MAP: Record<string, string> = {
  TIKTOK_ADS_OAUTH_STATE_INVALID: "state_invalid",
  TIKTOK_ADS_OAUTH_STATE_EXPIRED: "state_expired",
  TIKTOK_ADS_OAUTH_STATE_ALREADY_CONSUMED: "state_already_consumed",
  TIKTOK_ADS_OAUTH_TOKEN_EXCHANGE_FAILED: "token_exchange_failed",
  TIKTOK_ADS_OAUTH_ACCOUNT_DISCOVERY_FAILED: "account_discovery_failed",
  TIKTOK_ADS_OAUTH_ACCOUNT_DISCOVERY_EMPTY: "account_discovery_empty",
  TIKTOK_ADS_OAUTH_CONFIGURATION_ERROR: "configuration_error",
}
...
export class TikTokAdsOAuthController {
  constructor(private readonly service: TikTokAdsOAuthService) {}

  async start(actor: AuthenticatedActor, input: TikTokAdsOAuthStartInput) {
