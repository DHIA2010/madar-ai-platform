...
import { TikTokAdsRepository } from "./tiktok-ads.repository"

export const TIKTOK_ADS_CONNECTOR_DEFINITION: ConnectorDefinition = {
  connectorDefinitionId: "connector_def_tiktok_ads",
  key: "ads.tiktok",
  displayName: "TikTok Ads",
  description: "TikTok Ads connector with OAuth and advertising sync support.",
  version: "1.0.0",
...
const TIKTOK_ADS_CAPABILITIES: ConnectorCapability[] = [
  "campaigns",
  "ads",
  "traffic",
  "events",
...
export class TikTokAdsConnector implements ConnectorContract {
  readonly definition = TIKTOK_ADS_CONNECTOR_DEFINITION

  constructor(private readonly repository: TikTokAdsRepository = new TikTokAdsRepository()) {}
  ...
  getCapabilities(): ConnectorCapability[] {
    return TIKTOK_ADS_CAPABILITIES.slice()
  }
