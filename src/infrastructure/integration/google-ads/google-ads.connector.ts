...
export const GOOGLE_ADS_CONNECTOR_DEFINITION: ConnectorDefinition = {
  connectorDefinitionId: "connector_def_google_ads",
  key: "ads.google",
  displayName: "Google Ads",
  description: "Google Ads connector with OAuth and advertising sync support.",
  version: "1.0.0",
...
const GOOGLE_ADS_CAPABILITIES: ConnectorCapability[] = [
  "campaigns",
  "ads",
  "traffic",
  "events",
...
export class GoogleAdsConnector implements ConnectorContract {
  readonly definition = GOOGLE_ADS_CONNECTOR_DEFINITION

  constructor(private readonly repository: GoogleAdsRepository = new GoogleAdsRepository()) {}
  ...
  getCapabilities(): ConnectorCapability[] {
    return GOOGLE_ADS_CAPABILITIES.slice()
  }
